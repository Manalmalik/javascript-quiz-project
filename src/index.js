document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    progressBar.style.width = `${(quiz.currentQuestionIndex * 100) / 10}%`; // This value is hardcoded as a placeholder

    // 3. Update the question count text
    // Update the question count (div#questionCount) show the current question out of total questions

    questionCount.innerText = `Quest ${quiz.currentQuestionIndex} out of 10`; //  This value is hardcoded as a placeholder
  ...
  function nextButtonHandler() {
    ...
    const choicesInput = document.querySelectorAll("input");
